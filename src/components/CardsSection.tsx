...
const CardsSection = () => {
  ...
  return (
    <section
      className='max-w-[860px] mx-auto my-[108px]'
      aria-label="This Week's Specials Cards Section"
    >
        <div className='flex flex-col md:flex-row md:justify-between md:items-center'>
          <h2 className='font-markazi font-medium text-[64px]'>This Weeks Specials</h2>
          <a
            className='bg-lemonyellow text-black text-[18px] font-karla font-medium px-[16px] py-[8px] rounded-[16px] mb-[16px] md:mb-[0px] mr-auto md:mr-0'
            href="#"
        ...
        <div
          id='cards'
          className='flex justify-center sm:justify-between items-center flex-wrap px-[10px] md:px-[0px]'
          aria-label="Special menu items"
        >
